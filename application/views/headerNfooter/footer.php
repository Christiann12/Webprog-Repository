	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-sm-6 col-md-4 col-lg-4 left">
				<p class="pt-3 titlePar">Navigate to:</p>
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-4 mid">
				<p class="pt-3 titlePar">Follow us:</p>
			...
			<div class="col-12 col-sm-12 col-md-4 col-lg-4 right">
				<p class="pt-3 titlePar">Contact us:</p>
...
<!-- Script Source Files -->
	...
	<!-- jQuery -->
	<script src="../application/assets/js/jquery-3.5.1.min.js"></script>
	<!-- Bootstrap 4.5 JS -->
	<script src="../application/assets/js/bootstrap.min.js"></script>
	<!-- Popper JS -->
	<script src="../application/assets/js/popper.min.js"></script>
	<!-- Font Awesome -->
	<script src="../application/assets/js/all.min.js"></script>
</body>
</html>
